...
contract OuterSet is Owned, ValidatorSet {
    ...
    bytes4 private constant SIGNATURE = 0xb7ab4db5;
    ...
    // For innerSet.
    function initiateChange(bytes32 _parent_hash, address[] _new_set)
        public
        only_inner_and_finalized
    {
        finalized = false;
    ...
    // TODO: fix -> Warning: Function declared as view,
    // but this expression (potentially) modifies the state
    // and thus requires non-payable (the default) or payable.
